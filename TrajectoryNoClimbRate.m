classdef TrajectoryNoClimbRate < handle
    ...
    methods
        function obj = TrajectoryNoClimbRate(f_hz, waypoints_m, toa_s)
        ...
        function plot_all(obj, real_time)
