function [r_up,r_dn] = LEM_roundabout(obj,airways,v)
...
if length(angles)==1
    angles(2) = LBSD.LEM_posori(obj,angles(1) + 120*pi/180);
    angles(3) = LBSD.LEM_posori(obj,angles(2) + 120*pi/180);
    angles_nei(2) = -3;
    angles_nei(3) = -3;
end
if length(angles)==2
    ...
    if angle1>angle2
        ...
        angles(3) = LBSD.LEM_posori(obj,angles(2) + angle2/2);
    end
    angles_nei(3) = -4;
end
[angles,indexes] = sort(angles);
